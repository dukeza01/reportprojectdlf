...
"  'owner','quarter','note','lastEditedBy','lastEditedAt'",
'];',
'',
...
'    const widths = [50,220,260,110,80,90,90,110,90,260,240,100,100,140,80,200,140,160];',
...
'    note: row[15] || \'\', lastEditedBy: row[16] || \'\', lastEditedAt: row[17] || \'\'',
'  };',
'}',
'',
